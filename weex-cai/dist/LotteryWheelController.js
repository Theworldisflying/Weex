...
__vue_options__.__file = "/Users/miu_wen/Desktop/weex-project/weex-cai/node_modules/weex-ui/packages/wxc-mask/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-35bb9e14"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _WxcMask = _interopRequireDefault(__webpack_require__(33)).default;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = {
  components: { WxcMask: _WxcMask },
  props: {
    personRecord: [],
    overlayMask: false
  },
  ...
  // 过滤数据
  filters: {
    statusTest: function statusTest(e) {
      var getTest;
      switch (e) {
        case 0:
          getTest = '未审核';
  ...
  methods: {
    wxcMaskBodyClicked: function wxcMaskBodyClicked() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('wxc-mask', {
    ...
    on: {
      "wxcMaskSetHidden": _vm.wxcMaskBodyClicked
    }
  }, [_c('div', [_c('image', {
    staticStyle: {
      marginLeft: "0px",
    ...
    attrs: {
      "src": "../dist/prizeRecordListBg.png"
    }
  }), _c('div', {
    staticStyle: {
      height: "50px",
    ...
    staticClass: ["recordItemTitleStyle"]
  }, [_vm._v("我的中奖")]), _c('text', {
    staticClass: ["recordItemTitleStyle"],
    staticStyle: {
      marginLeft: "530px"
    ...
    on: {
      "click": _vm.wxcMaskBodyClicked
    }
  }, [_vm._v("X")])]), _c('list', {
    staticStyle: {
      height: "400px"
    }
  }, _vm._l((_vm.personRecord), function(item, i) {
    return _c('cell', {
      key: i,
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["recordItemDiv"]
    }, [_c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v("奖项")]), _c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v("中奖时间")]), _c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v("是否派送")])]) : _vm._e(), _c('div', {
      staticClass: ["recordItemDiv"]
    }, [_c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v(_vm._s(item.money) + "元现金筹码")]), _c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v(_vm._s(item.created_at))]), _c('text', {
      staticClass: ["itemCellStyle"]
    }, [_vm._v(_vm._s(_vm._f("statusTest")(item.status)))])])])
  }))])])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/miu_wen/Desktop/weex-project/weex-cai/src/LotteryWheelController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0225e7f2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcMask = __webpack_require__(33);
...
var _WheelContent = __webpack_require__(91);

var _WheelContent2 = _interopRequireDefault(_WheelContent);

var _DetailsStatement = __webpack_require__(92);

var _DetailsStatement2 = _interopRequireDefault(_DetailsStatement);

var _WheelRecordMask = __webpack_require__(93);

var _WheelRecordMask2 = _interopRequireDefault(_WheelRecordMask);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var libGCanvas = __webpack_require__(31); //
//
//
//
//
...
var navigatorWheel = weex.requireModule('navigator');
var animation = weex.requireModule('animation');
...
module.exports = {
  components: { WheelContent: _WheelContent2.default, DetailsStatement: _DetailsStatement2.default, WheelRecordMask: _WheelRecordMask2.default, WxcMinibar: _wxcMinibar2.default, WxcDialog: _wxcDialog2.default, WxcMask: _wxcMask2.default, WxcLoading: _wxcLoading2.default },
  data: function data() {
    return {
  ...
  created: function created() {
    var self = this;
    // 图片
    self.titleImg = _Global2.default.imgPath + 'wheelTitleImg.png';
    self.wheelImg.pointerImg = _Global2.default.imgPath + 'zhizhen.png';
    self.wheelImg.bannnersImg = _Global2.default.imgPath + 'banners.png';
    self.wheelImg.bottomDiskImg = _Global2.default.imgPath + 'bottomDisk.png';
    self.wheelImg.yuanpanImg = _Global2.default.imgPath + 'yuanpan.png';
    self.wheelImg.jiangxiangImg = _Global2.default.imgPath + 'jiangxiang.png';
    self.wheelImg.jiangpinzhanshiImg = _Global2.default.imgPath + 'jiangpinzhanshi.png';
    self.wheelImg.huodongxiangqingImg = _Global2.default.imgPath + 'huodongxiangqing.png';
    self.wheelImg.huodongshengmingImg = _Global2.default.imgPath + 'huodongshengming.png';
    self.wheelImg.choujiangtiaojianImg = _Global2.default.imgPath + 'choujiangtiaojian.png';
    ...
    eventModule.getToken('token', function (res) {
      ...
      stream.fetch({
        method: 'GET',
        url: _Global2.default.theWinnersUrl,
    ...
    //
    self.sliderImg = [{ src: _Global2.default.imgPath + '8.png' }, { src: _Global2.default.imgPath + '18.png' }, { src: _Global2.default.imgPath + '58.png' }, { src: _Global2.default.imgPath + '188.png' }, { src: _Global2.default.imgPath + '588.png' }, { src: _Global2.default.imgPath + '888.png' }];
  },
  ...
  methods: {
    ...
    // 顶部标题
    // 官方首页
    officialHomeClick: function officialHomeClick() {
      weex.requireModule(_Global2.default.eventModule).pushController({ vcName: 'LocalWebViewController', url: '1' });
    },

    // 代理加盟
    agentJoinClick: function agentJoinClick() {
      weex.requireModule(_Global2.default.eventModule).pushController({ vcName: 'LocalWebViewController', url: '1' });
    },

    // 手机投注
    phoneBetClick: function phoneBetClick() {
      weex.requireModule(_Global2.default.eventModule).pushController({ vcName: 'LocalWebViewController', url: '1' });
    },
    ...
    // 转盘按钮
    rotateClick: function rotateClick() {
      var rotateImg = this.$refs.bgImg;
      var self = this;
    ...
    // 转盘获取奖项数据
    clickLuckyPost: function clickLuckyPost() {
      var self = this;
      stream.fetch({
        method: 'POST',
        url: _Global2.default.postWheelLuckUrl,
    ...
    scroll: function scroll() {
      ...
      if (this.cellPosistion < this.$refs.list_cell.length - 3) {
        var el = this.$refs.list_cell[this.cellPosistion];
        dom.scrollToElement(el, { animated: true });
        this.cellPosistion = this.cellPosistion + 1;
      } else {
        this.cellPosistion = 0;
        var _el = this.$refs.list_cell[0];
        dom.scrollToElement(_el, { animated: false });
        // clearInterval()
      }
    },
    cellmove: function cellmove() {
    ...
    // 注册按钮
    rigisterBtnClick: function rigisterBtnClick(e) {
      weex.requireModule(_Global2.default.eventModule).pushController({ vcName: 'LocalWebViewController', url: '1' });
    },

    // 中奖记录
    recordBtnClick: function recordBtnClick(e) {
      var self = this;
      self.loadingShow = true;
      // 获取中奖记录列表
      stream.fetch({
        method: 'GET',
        url: _Global2.default.theWinnersOneUrl,
        headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'token': self.token, 'SITEID': self.SITEID },
        type: 'json'
      }, function (ret) {
    ...
    alertShowConform: function alertShowConform() {
    ...
    // 绘制梯形
    gcanvasTrapezoid: function gcanvasTrapezoid() {
      //  获取元素引用
      var ref = this.$refs.canvas_holder;
      // 创建gcanvas对象
      var gcanvas = libGCanvas.start(ref);
      // 获取context2D
      ...
      ctx.fill();
      //  获取元素引用
      var refBottom = this.$refs.canvas_holder_bottom;
      // 创建gcanvas对象
      var gcanvasBottom = libGCanvas.start(refBottom);
      // 获取context2D
      var ctxBottom = gcanvasBottom.getContext('2d');
      // 绘制等腰梯形
      // ctx.beginPath()
    ...
    // 线 圆
    gcanvasLine: function gcanvasLine() {
      //  line
      var w = 300;
      var y = 6;
      var r = y; // 半径
      var line1Ref = this.$refs.line;
      var linegcanvas = libGCanvas.start(line1Ref);
      var lineCtx = linegcanvas.getContext('2d');
      ...
      var y2 = 6;
      var r2 = y2; // 半径
      var line2Ref = this.$refs.line2;
      var linegcanvas2 = libGCanvas.start(line2Ref);
      var lineCtx2 = linegcanvas2.getContext('2d');
      ...
      var y3 = 6;
      var r3 = y2; // 半径
      var line3Ref = this.$refs.line3;
      var linegcanvas3 = libGCanvas.start(line3Ref);
      var lineCtx3 = linegcanvas3.getContext('2d');
...
__vue_options__.__file = "/Users/miu_wen/Desktop/weex-project/weex-cai/node_modules/weex-ui/packages/wxc-dialog/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7fa72492"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/miu_wen/Desktop/weex-project/weex-cai/src/WheelRecordMask.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-f766c6a2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('scroller', [_c('div', {
    ...
    staticClass: ["bannnersTitleDiv"]
  }, [_c('text', {
    staticClass: ["bannnersTitleStyle"],
    staticStyle: {
      marginLeft: "5px"
    },
    on: {
      "click": _vm.officialHomeClick
    }
  }, [_vm._v("官方首页")]), _c('text', {
    staticClass: ["bannnersTitleStyle"],
    on: {
      "click": _vm.agentJoinClick
    }
  }, [_vm._v("代理加盟")]), _c('text', {
    staticClass: ["bannnersTitleStyle"],
    on: {
      "click": _vm.phoneBetClick
    }
  }, [_vm._v("手机投注")]), _c('text', {
    staticClass: ["bannnersTitleStyle"],
    on: {
    ...
    staticClass: ["bannnersDiv"]
  }, [_c('image', {
    staticClass: ["bannners"],
    attrs: {
      "src": _vm.wheelImg.bannnersImg
    }
  }), _c('div', {
    staticClass: ["gcanvasDiv"]
  }, [_c('gcanvas', {
    ref: "canvas_holder",
    staticClass: ["gcanvasStyle"]
  }), _c('image', {
    staticClass: ["bottomDiskStyle"],
    attrs: {
      "src": _vm.wheelImg.bottomDiskImg
    }
  })], 1), _c('div', {
    staticClass: ["boxDiv"]
  }, [_c('div', {
    ...
    staticClass: ["box"],
    attrs: {
      "src": _vm.wheelImg.yuanpanImg
    }
  }), _c('image', {
    staticClass: ["boxContent"],
    attrs: {
      "src": _vm.wheelImg.jiangxiangImg
    }
  })]), _c('div', {
    staticClass: ["boxCenter"],
    on: {
      "click": _vm.clickLuckyPost
    }
  }, [_c('image', {
    staticClass: ["boxCenter"],
    attrs: {
      "src": _vm.wheelImg.pointerImg
    }
  })])])]), _c('div', {
    staticStyle: {
      backgroundColor: "#efeff4",
    ...
    staticClass: ["wheelRegisterStyle"],
    on: {
      "click": _vm.rigisterBtnClick
    }
  }, [_vm._v("注册彩33")]), _c('text', {
    staticClass: ["wheelRecoderStyle"],
    on: {
      "click": _vm.recordBtnClick
    }
  }, [_vm._v("我的中奖记录")])]), _c('div', {
    staticClass: ["luckyDrawConditionsDiv"]
  }, [_c('image', {
    staticClass: ["luckyDrawConditions"],
    attrs: {
      "src": _vm.wheelImg.choujiangtiaojianImg
    }
  }), _c('gcanvas', {
    ref: "line",
    staticClass: ["lineStyle"]
  })], 1), _c('WheelContent'), _c('div', {
    staticStyle: {
      backgroundColor: "#EC2829"
    }
  }, [_vm._m(0), _c('list', {
    ref: "list",
    staticStyle: {
  ...
  }, _vm._l((_vm.winningRecord), function(item, i) {
    return _c('cell', {
      key: i,
      ref: "list_cell",
      refInFor: true,
      ...
      staticClass: ["itemCellStyle"]
    }, [_vm._v("恭喜会员" + _vm._s(item.username.slice(0, 2)) + "***")]), _c('text', {
      staticClass: ["itemCellStyle", "itemcellSpaceStyle"]
    }, [_vm._v("抽中幸运奖金额" + _vm._s(item.money) + "元")]), _c('text', {
      staticClass: ["itemCellStyle", "itemcellSpaceStyle"]
    ...
    staticClass: ["luckyDrawConditions"],
    attrs: {
      "src": _vm.wheelImg.jiangpinzhanshiImg
    }
  }), _c('gcanvas', {
    ref: "line2",
    staticClass: ["lineStyle"]
  })], 1), _c('slider', {
    staticClass: ["sliderStyle"],
    attrs: {
      "interval": "3000",
      "autoPlay": "true"
    }
  }, _vm._l((_vm.sliderImg), function(item) {
    return _c('div', {
      key: item,
      staticClass: ["sliderFrameStyle"]
    }, [_c('image', {
      staticClass: ["sliderImageStyle"],
      attrs: {
        "resize": "stretch",
        "src": item.src
      }
  ...
  }, [_c('div', [(_vm.isDetailsClick) ? _c('image', {
    staticClass: ["details"],
    attrs: {
      "src": _vm.wheelImg.huodongxiangqingImg
    },
    on: {
      "click": _vm.detailsClick
    }
  }) : _vm._e(), (_vm.isDetailsClick === false) ? _c('image', {
    staticClass: ["statement"],
    attrs: {
      "src": _vm.wheelImg.huodongshengmingImg
    },
    on: {
      "click": _vm.detailsClick
    }
    ...
    ref: "line3",
    staticClass: ["lineStyleStatement"]
  })], 1), _c('DetailsStatement', {
    attrs: {
      "isDetailsClick": _vm.isDetailsClick
    }
  }), _c('div', {
    staticStyle: {
      height: "40px"
    ...
    ref: "canvas_holder_bottom",
    staticClass: ["gcanvasBottomStyles"]
  }), _c('div', {
    staticStyle: {
      backgroundColor: "#efeff4",
      height: "10px",
    ...
    attrs: {
      "personRecord": _vm.personRecord,
      "overlayMask": _vm.overlayMask
    }
  }), _c('wxc-dialog', {
    attrs: {
      ...
      "show": _vm.alertShow,
      "single": true,
      "mainBtnColor": _vm.alertsureBtnColor
    },
    on: {
      "wxcDialogConfirmBtnClicked": _vm.alertShowConform
    }
  }), _c('wxc-loading', {
    attrs: {
  ...
  return _c('div', {
    ...
    staticClass: ["itemTitleStyle"]
  }, [_vm._v("中奖名单")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('text', {
    staticClass: ["taggingStyle"]
  }, [_vm._v("Copyright◎彩33 Reserved | 18+")])])
}]}
module.exports.render._withStripped = true
